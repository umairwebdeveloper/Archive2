...
CREATE TABLE "UserVideoNote" (
    ...
    CONSTRAINT "UserVideoNote_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Question" (
    ...
    "explanation" TEXT NOT NULL DEFAULT 'Explanation',
...
CREATE TABLE "TutoringForm" (
    ...
    "tutoringSubjects" TEXT NOT NULL,
    "address" TEXT NOT NULL,
    "postalCode" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "TutoringForm_pkey" PRIMARY KEY ("id")
);
