		...
		<>
			<div className="my-20">
				<div className="container">
					<div className="bg-[rgb(250,250,250)] flex flex-col items-center justify-center text-center px-5 py-10 md:mb-10 rounded-xl">
						<h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
							Waarom{" "}
							<span style={{ color: "rgb(0, 162, 16)" }}>
								Gotutor
							</span>{" "}
							de juiste keuze is?
						</h2>

						<p className="contents text-black-600 text-base md:text-lg max-w-2xl mb-10">
							Een examentraining is onder andere geschikt voor
							leerlingen die moeite hebben met een of meerdere
							vakken, een goede cijferlijst nodig hebben voor een
							vervolgopleiding of die behoefte hebben aan extra
							zekerheid. Zo zitten er veel voordelen aan het
							volgen van een examentraining.
						</p>

						<div className="flex flex-col md:flex-row items-start justify-center gap-4 w-full mt-10">
							{/* Left container */}
